...
class TimesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Times->save($time)) {
                ...
                $this->Flash->error('The time could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Times->delete($time)) {
            $this->Flash->success('The time has been deleted.');
        } else {
            $this->Flash->error('The time could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
